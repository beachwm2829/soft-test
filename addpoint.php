                                ...
                                <div class="tab-pane fade show active" id="nav-places" role="tabpanel" aria-labelledby="nav-places-tab">
                                    ...
                                    <form action="#" method="get">
                                        ...
                                        <button type="submit" class="btn dorne-btn"><i class="fa fa-search pr-2" aria-hidden="true"></i>รอบฉาย <button>
                                                ...
                                                <center><h2>จัดการข้อมูล Point <br></center>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <div class="about-content text-center">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col" align="right"><button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#addDatamovie">เพิ่มPoint +</button></div>
                                                                            <div class="col"align="center"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#DeleteDatamovie">ลบPoint -</button></div>
                                                                            <div class="col"align="left"><button type="button" class="btn btn-warning" data-toggle="collapse" data-target="#EditDatamovie">แก้ไขPoint +</button></div>
                                                                        </div>
