...
<head>
    <?php 
        ...
        $con = new connectdb();
        if($con ->connichdb()){
            $sql_user = "SELECT * FROM ticket WHERE memid='".$_SESSION["mid"]."'";
    ...
    <title>การชำระเงิน | Garle Cinema</title>
    <style>
        .mySlides {
            display: none;
        }
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm" align="rigth">
                                            <img src="img/QR_code_for_mobile_English_Wikipedia.svg.png" class="rounded" alt="Cinque Terre">
                                        </div>
                                        <div class="col-sm" align="left">
                                            <form action="payment-ticket.php" method="post"><div class="col-sm" align="left">
                                            <br><br><br><br><br>
                                            <h3 style="color: black"><?php echo $row["movie"] ?></h3>
                                            <!--ชิ่อหนัง -->
                                            <h6 style="color: blue"><?php echo $row["date"]; ?> | <?php echo $row["timeshow"]; ?></h6>
                                            <!--วัน - เวลา -->
                                            <h4 style="color: black">โรงภาพยนต์</h4>
                                            <h6 style="color: blue"><span class="glyphicon glyphicon-map-marker"></span><?php echo $row["cinema"] ?></h6>
                                            <div class="row">
                                                <div class="col-sm-6">
