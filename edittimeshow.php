...
<html>
    ...
    <body>
        ...
        <form action='sentedittimeshow.php' method='POST' >
            <section>
                <div class="container">
                    <h2 class="text-center mt-0">แก้รอบหนัง</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group ">
                                ...
                                <input type="text" align="center" style="width: 50%;" class="form-control"  placeholder="รหัสโรงหนัง" name='CID'>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group ">
                                ...
                                <input type="text" align="center" style="width: 50%;" class="form-control" placeholder='เวลา' name='TIME'>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group ">
                                <input class="btn btn-light btn-xl js-scroll-trigger" type="submit" value="แก้ไขรอบหนัง">
                            </div>
                        </div>
                    </div>
